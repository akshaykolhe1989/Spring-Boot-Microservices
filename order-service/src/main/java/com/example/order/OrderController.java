...
public class OrderController {
	...
	private final Environment environment;
			...
			/*
			 * @GetMapping public List<Order> getAllOrders() { return orders; }
			 */
	...
	/*
	 * @GetMapping public List<Order> getAllOrders(@RequestParam(required = false)
	 * Integer customerId) { if (customerId != null) { return orders.stream()
